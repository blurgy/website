...
class Word {
	...
	conjugation() {
		if (this.type.slice(0, 4) === 'verb') return conjugate(this);else return null;
	}
	declension() {
...
var V = {
	...
	nouns: {
		...
		anima: new Word({
			...
			notes: '<p>' + '<b>physical meaning</b>: \'breath\' of a human being. <br><b>by extension</b>: \'breath\' of life, \'life force\'.' + '<br>Means \'soul\' in the sense of what gives an animate being life.' + '</p>', // *
			type: 'noun 1',
			specialSyntax: null
		}),
		dea: new Word({
		...
		fama: new Word({
			...
			notes: '<p>' + 'From Indo-European word for \'speak\'. Indicates what is spoken publicly or by the people. Basic meaning is \'talk\' (something spoken) or \'rumor\'.' + _('<br> A <b>fa_ma</b> often told becomes a \'story\'. A person\'s <b>fa_ma</b> is his or her \'reputation\' or \'fame\'.') + 'When capitalized, means the goddess \'Rumor\'.' + '</p>',
			type: 'noun 1',
			specialSyntax: null
		}),
		femina: new Word({
		...
		animus: new Word({
			...
			notes: '<p>' + 'Distinct from <span class="Latin">anima</span>, the physical soul that descends to the underworld. May mean <i>heart</i>, as the source of emotion and passion, or may indicated a specific passion.' + '<br> In the plural, often means \'spirits\' in the sense of \'strong feelings\', and in certain contexts, \'anger\', \'courage\', or \'pride\'.' + '</p>',
			type: 'noun 2',
			specialSyntax: null
		}),
		arma: new Word({
		...
		homo: new Word({
			...
			notes: '<p>' + 'More neutral than <span class="Latin">vir</span>, which is always explicitly male, and may convey the notion of a man of honor and principle.' + _('<br> When a man from an unestablished family achieved a major political office for the first time, he was called a <span class="Latin">homo_ novus</span> - new man. The term often carried an implied insult.') + '<bt> The plural forms often mean \'people in general\', as opposed to <span class="Latin">populus</span>, a specific people.' + '<br><u>Ex.</u> <b class="Latin">Homine_s multa impia di_cunt.</b> - <i>People say many wicked things.</i>' + '</p>',
			type: 'noun 3',
			specialSyntax: null
		}),
		hostis: new Word({
		...
		ars: new Word({
			...
			notes: '<p>Any "skill" acquired through practice. May be used of any "craft" or "trade." May also mean a specific body of knowledge (e.g. the "art" or "science" of divination). Sometimes used of a particular "work of art."' + '<br>In contrast to <b class="Latin">na_tu_ra</b> or <b class="Latin">ingenium</b>, may have a negative sense (artificiality, craftiness), or a positive one (art). From the idea of artificiality, it comes to mean "guile" or "trick."' + '<br>The term <b class="Latin">bonae arte_s</b> means "liberal studies" or "cultural pursuits," those pursuits that are the mark of a civilized society.' + '</p>',
			type: 'noun 3i',
			specialSyntax: null
		}),
		civitas: new Word({
		...
		modus: new Word({
			...
			notes: '<p>The prepositional phrases <b class="Latin">in...modum</b> and <b class="Latin">ad...modum</b> (in the manner, according to the manner), frequently occur with a genitive or with an adjective modifying <b class="Latin">modum</b>.' + '<br><u>Ex:</u> <b class="Latin">Re_gis in/ad modum di_xit</b> - <i>She spoke in/according to the manner of a king.</i>' + '<br><u>Ex:</u> <b class="Latin">In/Ad hunc modum di_xit.</b> - <i>She spoke in/according to this manner.</i>' + '</p>',
			type: 'noun 2',
			specialSyntax: null
		}),
		oculus: new Word({
	...
	verbs: {
		...
		dono: new Word({
			...
			notes: '<p>' + 'A <i>denominative verb</i> - (derived from nouns or adjectives), <span class="Latin">' + _('do_no_') + '</span> is derived from the noun <span class="Latin">' + _('do_num') + '</span>.' + '<br>Like all verbs of giving, showing, and teling, it regularly takes a direct object and indrect object, e.g. <span class="Latin">' + _('Poe_tae pecu_niam do_na_mus') + '</span> - <i>We are giving money to the poet.</i> In this case, <span class="Latin">' + _('do_no_') + '</span> is a synonym of <span class="Latin">' + _('do_') + '</span>.' + '<br>When it means "present" or "reward", it takes a direct object or an Ablative of Means, e.g. <span class="Latin">' + _('Poe_tam pecu_nia_ do_na_mus.') + '</span> - <i> We are rewarding the poet with (by means of) money.</i>' + '</p>',
			type: 'verb 1T',
			specialSyntax: null
		}),
		erro: new Word({
		...
		debeo: new Word({
			...
			notes: '<p>' + 'When taking a direct object, should be translated "owe". When followed by a Complementary Infinitive, should be translated "ought".' + '</p>',
			type: 'verb 2',
			specialSyntax: null
		}),
		habeo: new Word({
		...
		timeo: new Word({
			...
			notes: '<p>' + 'Transitive but may be used absolutely. May be accompanied by a Dative of Reference or by the preposition <span class="Latin">' + _('de_') + '</span> (as well as by other prepositions).' + '<br>Example: <span class="Latin">Agricola timet.</span> - <i>The farmer is afraid (used absolutely).</i>' + '<br>Example: <span class="Latin">' + _('Agricola re_gi_nam timet.') + '</span> - <i>The farmer fears the queen (transitive).</i>' + '<br>Example: <span class="Latin">' + _('Agricola re_gi_nae timet.') + '</span> - <i>The farmer fears for the queen (with dative).</i>' + '<br>Example: <span class="Latin">' + _('Agricola de_ fi_lio_ timet.') + '</span> - <i>The farmer is afraid about (his) son. (with <span class="Latin">' + _('de_') + '</span> + ablative).</i>' + '</p>',
			type: 'verb 2',
			specialSyntax: {
				indicative: {
					passive: {
		...
		video: new Word({
			...
			notes: '<p>' + 'When <span class="Latin">' + _('video_') + '</span> means "be seen", it is often accompanied by an Ablative of Personal Agent, e.g. <span class="Latin">' + _('Poe_ta a_ re_gi_na_ vide_tur.') + '</span> - <i>The poet is (being) seen by the queen.</i>' + '<br>When <span class="Latin">' + _('video_') + '</span> means "seem" (i.e. be seen as), it functions as a copulative verb with a Predicate Nominative or Predicate Adjective in the nominative case. It may also be accompanied by a Complementary Infinitive, a Dative of Reference, or both. e.g. <span class="Latin">' + _('Miser re_gi_nae poe_ta (esse) vide_tur.') + '</span> - <i> The poet seems to the queen (to be) wretched.' + '</p>',
			type: 'verb 2',
			specialSyntax: null
		}),
		sum: new Word({
			...
			definition: 'be; exist',
			notes: '<p>' + '<span class="Latin">sum</span> is an intransitive verb. It may function as a copulative verb, equating the subject with a predicate nominative, and usually found between them, e.g. <span class="Latin">' + _('Re_gi_na est fi_lia deae.') + '</span> - <i>The queen is the daughter of a goddess</i>. It may also assert the existence of the subject, in which case it often (but not always) precedes the subject, e.g. <span class="Latin">' + _('Est re_gi_na in i_nsula_.') + '</span> - <i>There is a queen on the island</i>.' + '<br><span class="Latin">' + _('futu_rus') + '</span> (<i>about to be</i>) is the future active participle.' + '</p>',
			type: 'verb Irr',
			specialSyntax: {
				indicative: {
					active: {
		...
		possum: new Word({
			...
			notes: '<p>' + '<span class="Latin">possum</span> is an intransitive verb, regularly followed by a <i>Complementary Infinitive</i>.' + '</p>',
			type: 'verb Irr',
			specialSyntax: {
				indicative: {
					active: {
		...
		pugno: new Word({
			...
			definition: 'fight',
			notes: '<p>Often takes an Ablative of Accompaniment that indicates the person <i>against</i> whom one is fighting.' + '<br><u>Ex.</u> <b class="Latin">Nautae cum agricoli_s pugnant.</b> - <i>The sailors are fighting with the farmers.</i>' + '</p>',
			type: 'verb 1I',
			specialSyntax: null
		}),
		supero: new Word({
		...
		teneo: new Word({
			...
			notes: '<p>' + 'May mean "hold" something in one\'s hands or "grasp" something with one\'s intellect. Has accessory idea of maintaining possession of something once held or grasped. May also mean "occupy" in the sense of holding to one\'s place of habitation.' + '</p>',
			type: 'verb 2',
			specialSyntax: null
		}),
		ignosco: new Word({
		...
		ago: new Word({
			...
			notes: '<p>' + 'Desribes action generally, its particular meanings being derived from context and the direct objects accompanying the verb. May mean "drive" (cattle, goats, plunder, a chariot, the winds); "do," "act," "manage," "plead" (a court case); or "spend," "conduct" (time, life).' + '<br>The present active imperative is often used to strengthen other commands, e.g.' + '<br>Ex. <b class="Latin"><u>Age</u>, do_na_ puelli_s do_na!</b> - <i><u>Come on</u>, give gifts to the girls!</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: null
		}),
		cano: new Word({
			...
			definition: 'sing (of)',
			notes: '<p>' + 'A transitive verb that takes a direct object. e.g. <span class="Latin">' + _('Poe_ta bellum cane_bat.') + '</span> - <i> The poet was singing of war.</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: null
		}),
		capio: new Word({
		...
		gero: new Word({
			...
			notes: '<p>' + 'Has three distinct senses: 1. "bear" or "carry" (equipment, clothing); 2. "have" or "bear" as a permament or temporary feature of body or mind (wounds, reputation, anger); and 3. "manage," "conduct," or "perform" (oneself, business, political office).' + '</p>',
			type: 'verb 3',
			specialSyntax: null
		}),
		mitto: new Word({
			...
			definition: 'send',
			notes: '<p>' + 'Regularly found with two constructions indicating the recipient: <span class="Latin">ad</span> + accusative or a Dative of Reference.' + '<br>Example: <span class="Latin">' + _('Agricola ad fi_lium pecu_niam mittit.') + '</span> - <i>The farmer sends money to his son.</i>' + '<br>Example: <span class="Latin">' + _('Agricola fi_lio_ pecu_niam mittit.') + '</span> - <i>The farmer sends money to his son.</i>' + '<br>In the first case, emphasizes <i>motion toward</i> someone or something. In the second case, emphasizes the <i>person for whom</i> something is meant.' + '</p>',
			type: 'verb 3',
			specialSyntax: null
		}),
		pono: new Word({
			...
			notes: '<p>' + 'Has two distinct meanings.' + '<br>Example: <span class="Latin">' + _('Incolae arma in oppido_ po_nunt.') + '</span> - <i>The inhabitants are placing weapons in the town.</i>' + '<br>Example: <span class="Latin">' + _('Incolae arma po_nunt.') + '</span> - <i>The inhabitants are setting aside (their) weapons.</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: null
		}),
		rego: new Word({
		...
		audio: new Word({
			...
			notes: '<p>' + 'A transitive verb that may be used absolutely. When it takes a direct object, it is translated "hear" or "listen to". When used absolutely, translated "hear" or "listen."' + '<br>Example: <span class="Latin">' + _('Re_gi_na incola_s audit.') + '</span> - <i>The queen listens to / hears the inhabitants.</i>' + '<br>Example: <span class="Latin">' + _('Re_gi_na audit') + '</span> - <i>The queen listens / hears.</i>' + '</p>',
			type: 'verb 4',
			specialSyntax: null
		}),
		sentio: new Word({
			...
			notes: '<p>' + 'Note that <span class="Latin"> -ns </span> <i>always</i> lengthens a preceding vowel (e.g. <span class="Latin">' + _('i_nsula') + '</span>' + '<br>The basic meaning is "perceive through one of the senses". Thus it has an intellectual sense (perceive, observe, notice) and a more physical or emotional sense (experience, feel, suffer).' + '</p>',
			type: 'verb 4',
			specialSyntax: null
		}),
		venio: new Word({
		...
		accedo: new Word({
			...
			notes: '<p>Compound Verb: <b class="Latin">ad-</b> + <b class="Latin">ce_do_</b>. Most often intransitive, and regularly followed by <b class="Latin">ad-</b> + accusative, where the preposition <b class="Latin">ad</b> repeats the prefix <b class="Latin">ad-</b> and often cannot be translated.' + '<br><u>Ex.</u> <b class="Latin">Auxilia ad oppidum acce_de_bant.</b> - <i>The auxiliary troops were approaching (toward) the town.</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: null
		}),
		discedo: new Word({
		...
		fero: new Word({
			...
			notes: '<p>May also mean "say", "report", particularly when a common story or a myth is being reported. When it takes a reflexive pronoun as a direct object, the combination may mean "proceed (quickly)," "go".' + '<br><u>Ex.</u> <b class="Latin">Auxilium viri_s pro_vinciae fero_.</b> - <i>I am brining aid to the men of the province.</i>' + '<br><u>Ex.</u> <b class="Latin">Multa mala tuli_.</b> - <i>I have endured many evil things.</i>' + '<br><u>Ex.</u> <b class="Latin">Me_ ad pro_vinciam fere_bam.</b> - <i>I was proceeding (quickly) to the province.</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: {
				indicative: {
					active: {
		...
		memini: new Word({
			...
			notes: '<p>(A <i>defective verb</i> - Uses perfect active forms of the indicative with present active meaning.) Often takes an Objective Genitive, also called the <i>Genitive with Verbs of Remembering and Forgetting</i>.' + '<br><u>Ex.</u> <b class="Latin">Meministi_ne patriae?</b> - <i>Do you remember your homeland? (Objective Genitive)</i>' + '<br><u>Ex.</u> <b class="Latin">Id memineram.</b> - <i>I was remembering it. (Accusative, Direct Object)</i>' + '<br>Uses future active forms of the imperative with present active meaning.' + '</p>',
			type: 'verb Def',
			specialSyntax: {
				imperative: {
					active: {
		...
		odi: new Word({
			...
			definition: 'hate',
			notes: '<p>(A <i>defective verb</i> - Uses perfect active forms of the indicative with present active meaning.)' + '<br>Has no imperative forms.' + '</p>',
			type: 'verb Def',
			specialSyntax: null
		}),
		redeo: new Word({
		...
		libero: new Word({
			...
			notes: '<p>Often accompanied by an Ablative of Separation.' + '<br><u>Ex:</u> <b class="Latin">Incola_s peri_culo_ li_bera_vimus.</b> - <i>We freed the inhabitants from danger.</i>' + '</p>',
			type: 'verb 1T',
			specialSyntax: null
		}),
		careo: new Word({
			...
			notes: '<p>Takes an Ablative of Separation that may be translated as a direct object in English.' + '<br><u>Ex:</u> <b>Agricola ami_ci_s no_n caret.</b> - <i>The farmer is not without (does not lack) friends.</i>' + '<br><u>Ex:</u> <b>Fi_lius re_gi_nae cu_ri_s caruit.</b> - <i>The son of the queen was free from cares.</i>' + '</p>',
			type: 'verb 2',
			specialSyntax: null
		}),
		lego: new Word({
		...
		maneo: new Word({
			...
			notes: '<p>' + 'With <b class="Latin">in</b> + ablative may mean "remain steady" or "abide (by)" (the truth, a conviction, a pact). Usually intransitive, but may be transitive - to "await" or "wait for" someone or something. Its compounds do <i>not</i> exhibit vowel weakening.' + '<br><u>Ex:</u> <b class="Latin">Ubi incolae discesse_runt, ma_nsimus.</b> - <i>When the inhabitants departed, we remained.</i>' + '<br><u>Ex:</u> <b class="Latin">Sulla semper in sententia_ ma_nsit.</b> - <i>Sulla always remained (steady) in (his) opinion.</i>' + '<br><u>Ex:</u> <b class="Latin">Fa_ta et bonum virum manent.</b> - <i>Death awaits even the good man.</i>' + '</p>',
			type: 'verb 2',
			specialSyntax: null
		}),
		terreo: new Word({
		...
		peto: new Word({
			...
			notes: '<p>When meaning "ask (for)" or "seek", takes a direct object of the thing asked. The person from whom something is sought is expressed by <b class="Latin">a_ / ab</b> + ablative. When it means "attack," it takes a direct object of the person or thing atacked. Its compounds do <i>not</i> exhibit vowel weakening.' + '<br><u>Ex:</u> <b class="Latin">Servus pecu_niam a_ domino_ petit.</b> - <i>The slave asks for money from (his) master.</i>' + '<br><u>Ex:</u> <b class="Latin">Servus gladio_ dominum petit.</b> - <i>The slave attacks (his) master with a sword.</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: {
				indicative: {
					active: {
		...
		differo: new Word({
			...
			notes: '<p>A compound verb formed by the addition of the prefix <b class="Latin">dis-</b> to <b class="Latin">fero_</b>. More often intransitive ("differ", "be different") than transitive, and may appear with an Ablative of Respect. The person or group from whom one differs is usually expressed in the ablative case with the preposition <b class="Latin">a_ / ab</b>.' + '<br><u>Ex:</u> <b class="Latin">A_ fra_tre sententia_ differt.</b> - <i>He differs from (his) brother in (respect to) (his) opinion.</i>' + '</p>',
			type: 'verb 3',
			specialSyntax: {
				indicative: {
					active: {
	...
	adjectives: {
		...
		amicus: new Word({
			...
			notes: '<p>' + 'Often found with a Dative of Reference indicating the person to whom someone is friendly. The dative is often found between the adjective and the noun that it modifies, e.g. <span class="Latin">' + _('Re_gi_na animam pueri_s ami_cam habet.') + '</span> - <i>The queen has a soul friendly to boys.</i>' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: ''
		}),
		inimicus: new Word({
			...
			notes: '<p>' + 'Often found with a Dative of Reference indicating the person to whom someone is unfriendly. The dative is often found between the adjective and the noun that it modifies, e.g. <span class="Latin">' + _('Re_gi_na animam pueri_s inimi_cam habet.') + '</span> - <i>The queen has a soul hostile to boys.</i>' + '<br> <span class="Latin">' + _('inimi_cus') + '</span>  is a compound adjective formed by the addition of the prefix <span class="Latin">in-</span> (<i>not</i>) to <span class="Latin">' + _('ami_cus') + '</span> (<i>friendly</i>)' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: ''
		}),
		bonus: new Word({
		...
		laetus: new Word({
			...
			definition: 'happy',
			notes: '<p>' + 'When describing plants, crops, etc., or when used to metaphorically describe literary or oratorical style, may mean <i>flourishing</i>, <i>rich</i>, or <i>luxuriant</i>. When describing omens or weather, often carries the notion of <i>favorable</i> or <i>propitious</i>.' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: ''
		}),
		liber: new Word({
			...
			definition: 'free',
			notes: '<p>' + 'Means <i>free</i> in a general sense (unrestrained, open), and in a social sense (free as opposed to enslaved).' + '<br><span class="Latin">' + _('Li_beri_, li_bero_rum, m. pl.') + '</span> is a substantive of the adjective <span class="Latin">' + _('li_ber, li_bera, li_berum') + '</span>, and means <i>children</i>.' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: ''
		}),
		magnus: new Word({
			...
			notes: '<p>' + 'Has both a <i>quantitative</i> sense (big, large) and a <i>qualitative</i> sense (great).' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: ''
		}),
		malus: new Word({
		...
		meus: new Word({
			...
			definition: 'my, mine',
			notes: '<p>' + 'Possessive adjectives may precede or follow the nouns the modify.' + '<br>They may function as substantives, e.g. <span class="Latin">' + _('meo_rum') + '</span> - <i>of my men</i> or <i>of my things</i>.' + '<br>They may express the <i>idea</i> of a Subjective Genitive (less frequently an Objective Genitive), e.g. <span class="Latin">' + _('Magna erat mea cu_ra populi_') + '</span>. - <i>Great was my care of (for) the people</i>.' + '<br>They are often omitted if the meaning is clear without them, but they are used for added clarity, emphasis, or contrast.' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: {
				vocative: {
					singular: {
		...
		mea: new Word({
			statement: 'meus, mea, meum',
			definition: 'my (own)',
			notes: '<p>' + 'First and second person reflexive-possessive adjectives are borrowed from possessive adjectives and differ in translation only.' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: null
		}),
		tua: new Word({
		...
		suus: new Word({
			...
			notes: '<p>' + 'The third person reflexive-possessive adjective may refer to a singular or plural subject.' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: null
		}),
		ipse: new Word({
			...
			notes: '<p>' + 'An intensive adjective <i>emphasizes</i> or <i>intensifies</i> the noun in modifies.' + '<br>Example: <span class="Latin">' + _('Catili_na ipse ad pro_vinciam it.') + '</span> - <i> Catiline himself is going to the province.</i>' + '<br>Example: <span class="Latin">' + _('Ipsa ad pro_vinciam i_bam.') + '</span> - <i> I myself (f.) was going to the province.</i>' + '<br>Example: <span class="Latin">' + _('Anto_nius causum ipsam co_gitat.') + '</span> - <i> Antony is pondering the case itself.</i>' + '<br>Example: <span class="Latin">' + _('In ipsi_s agri_s re_gi_nae eram.') + '</span> - <i> I was in the very fields of the queen.</i>' + '<br><span class="Latin">ipse</span> often appears in sentences containing reflexive pronouns and modifies the subject <i>or</i> the reflexive pronoun.' + '<br>Example: <span class="Latin">' + _('Ipse pro_ se_ pugna_bat.') + '</span> - <i>He himself was fighting for himself.</i>' + '<br>Example: <span class="Latin">' + _('Pro_ se_ ipso_ pugna_bat') + '</span> - <i>He was fighting for his very self.</i>' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: {
				genitive: {
					singular: {
		...
		carus: new Word({
			...
			notes: '<p>When it takes a dative, the dative is often found between the adjective and the noun that it modifies.' + '<br><u>Ex:</u> <b class="Latin">Incolae di_s ca_ri_ disce_dunt.</b> - <i>The inhabitants dear to the gods are departing.</i>' + '</p>',
			type: 'adjective 1,2',
			specialSyntax: null
		}),
		certus: new Word({
		...
		hic: new Word({
			...
			notes: '<p>Regularly precedes the noun it modifies.' + '<br>When used substantively (as a <i>demonstrative pronoun</i>) in the neuter form, may point to either what has preceded or what is to follow, and is translated "this/these preceding/following thing(s)."' + '<br>When used together with <b class="Latin">ille</b> to refer to two elements previously mentioned, means "the latter," while <b class="Latin">ille</b> means "the former."' + '</p>',
		...
		iste: new Word({
			...
			notes: '<p>Regularly precedes the noun it modifies.' + '<br>May be used to express contempt, translated "that / those (contemptible) ---- (of yours)."</p>',
			type: 'adjective demonstrative',
			specialSyntax: null
		}),
		ille: new Word({
			...
			notes: '<p>Regularly precedes the noun it modifies.' + '<br>May be used to point to what is celebrated or notorious, often placed after the noun it modifies.' + '<br>When used substantively (as a <i>demonstrative pronoun</i>) in the neuter form, may point to either what has preceded or what is to follow, and is translated "that/those preceding/following thing(s)."' + '<br>When used together with <b class="Latin">hic</b> to refer to two elements previously mentioned, means "the former," while <b class="Latin">hic</b> means "the latter."' + '</p>',
			type: 'adjective demonstrative',
			specialSyntax: null
		}),
		...
		alius: new Word({
			...
			notes: '<p>Used in various expressions where it is repeated and special translations are required.' + '<br><u>Ex:</u> <b class="Latin">Alia aurum, alia sapientiam optat.</b> - <i>One woman desires gold, another wisdom.</i>' + '<br><u>Ex:</u> <b class="Latin">Alii_ ci_ve_s bellum gerere optant, alii_ timo_re fugere.</b> - <i>Some citizens desire to wage war, others to flee because of fear.</i>' + '<br>In a parallel construction as above, its forms must be in the same gender, number, and case. Such sentences are translated "one...another..." in the singular or "some...other(s)..." in the plural.' + '</p>',
		...
		alter: new Word({
			...
			notes: '<p>Used in various expressions where it is repeated and special translations are required.' + '<br><u>Ex:</u> <b class="Latin">Alter in agro_ labo_rat, alter in urbe.</b> - <i>One man (of two) works in the field, the other in the city.</i>' + '<br>In a parallel construction as above, its forms must be in the same gender, number, and case. Such sentences are translated "(the) one...the other..."' + '<br><u>Ex:</u> <b class="Latin">Alio_s servo_s alio_ in agro_ vi_de_runt.</b> - <i>They saw some slaves in one field, other slaves in another field.</i>' + '<br>In the sentence above, two forms in different cases are used, having a <i>complementary</i> relation. A comparison is implied, and the first part of the comparison should be supplied in the translation.' + '</p>',
			type: 'adjective pronominal',
			specialSyntax: null
		}),
		idem: new Word({
		...
		uter: new Word({
			...
			notes: '<p>An <i>interrogative</i> adjective, assuming only two possible answers to the question it poses. Often used substantively.' + '<br><u>Ex:</u> <b class="Latin">In utro_ oppido_ vi_vis?</b> - <i>In which town (of two [towns]) do you live?</i>' + '<br><u>Ex:</u> <b class="Latin">Utrum vide_re opta_s?</b> - <i>Which (man or thing) (of two) do you desire to see?</i>' + '</p>',
			type: 'adjective pronominal',
			specialSyntax: null
		}),
	...
	prepositions: {
		...
		pro: new Word({
			...
			notes: '<p>' + '<br><u>Ex.</u> <b class="Latin">Est via <u>pro_</u> oppido_.</b> - <i>There is a street <u>in front of</u> the town.</i>' + '<br><u>Ex.</u> <b class="Latin"><u>Pro_</u> fi_lii_s labo_rat.</b> - <i>He works <u>on behalf of</u> (his) sons.</i>' + '<br><u>Ex.</u> <b class="Latin"><u>Pro_</u> facti_s poena_s dabit.</b> - <i>He will pay the penalty <u>in return for (in exchange for)</u> his deeds.</i>' + '</p>',
			type: 'preposition',
			specialSyntax: null
		}),
		propter: new Word({
		...
		sub: new Word({
			...
			notes: '<p>When it takes the accusative, it conveys either an idea of motion "under" or of motion from below "up to" a place. When it takes an ablative, it indicates something "under", "at the foot of", "close up to", or "near" which someone or something is located.' + '<br><u>Ex:</u> <b class="Latin">Mi_lite_s sub moenia mi_sit.</b> - <i>He sent the soldiers up to the city walls.</i>' + '<br><u>Ex:</u> <b class="Latin">Erant mi_lite_s sub oppido_.</b> - <i>There were sailors near the town.</i>' + '</p>',
			type: 'preposition',
			specialSyntax: null
		}),
		...
		ante: new Word({
			...
			notes: '<p>As an adverb, <b class="Latin">ante</b> most frequently has a temporal sense, but sometimes conveys the spatial sense of "ahead" or "in advance". As a preposition, it may have a temporal or a spatial sense.' + '<br><u>Ex:</u> <b class="Latin">Mi_lite_s ante ambula_bant.</b> - <i>The soldiers were walking ahead (in front).</i> (Adverb)' + '<br><u>Ex:</u> <b class="Latin">Verba poe_tae ante no_n intelle_xi_.</b> - <i>I did not understand the words of the poet before (previously).</i> (Adverb)' + '<br><u>Ex:</u> <b class="Latin">Nauta ante templum ambula_bat.</b> - <i>The sailor was walking in front of the temple.</i> (Preposition)' + '<br><u>Ex:</u> <b class="Latin">Ante bellum miseri_ erant incolae.</b> - <i>Before the war the inhabitants were miserable.</i> (Preposition)' + '</p>',
			type: 'preposition',
			specialSyntax: null
		}),
		post: new Word({
	...
	conjunctions: {
		...
		et: new Word({
			...
			notes: '<p>' + 'When acting as a conjunction, <b>et</b> is a <b>coordinating conjunction</b>, which means that it connects only parallel or grammatically balanced words, phrases, or clauses. When two nouns are connected, they must be in the same case.' + '<br>When acting as an adverb, <b>et</b> usually qualifies a <i>single</i> noun, verb, or adjective, e.g. <b>et vir</b> (<i>even the man</i>, or <i>the man also</i>).' + '</p>', // *
			type: 'conjunction',
			specialSyntax: '' // *
		}),
		'-que': new Word({
			...
			notes: _('<p>' + '<b>-que</b> is an <b>enclitic conjunction</b>, from the Greek <span class="Latin">enkli_no_</span> (<i>lean on</i>), and as such, is directly attached to the word preceding it.' + '<b>-que</b> is attached to the <i>second</i> element of a closely related pair, whose elements are often opposite or complementary, e.g. <b>vir fe_minaque</b> (<i>husband and wife</i>). Like <b>et</b>, it may connect grammatical elements other than nouns.' + '</p>'), // *
			type: 'conjunction',
			specialSyntax: '' // *
		}),
		...
		enim: new Word({
			...
			notes: _('<p>' + '<b class="Latin">Enim</b> is postpositive (\<<span class="Latin">postpo_no_</span> - <i>put after</i>) because it is regularly <i>placed after</i> the first word (or second word) of a sentence. <b class="Latin">Enim</b> is used to join two sentences or clauses when the second sentence or clause <u>explains</u> (<i>for</i>) or <u>confirms</u> (<i>in fact, indeed</i>) a preceding one.'
			// + '<br><u>Ex.</u> <b class="Latin"><u></u></b> - <i><u></u></i>'
			+ '<br><u>Ex.</u> <b class="Latin">Re_gi_na ad oppidum ambulat. Do_na <u>enim</u> di_s dare optat.</b> - (explanation) <i>The queen is walking to the town. <u>For</u> she desires to give gifts to the gods.</i>' + '<br><u>Ex.</u> <b class="Latin">Agricola ve_la dare optat. Nihil <u>enim</u> timet.</b> - (confirmation) <i>The farmer desires to set sail. <u>Indeed</u>, he is afraid of nothing.</i>' + '<p>'),
			type: 'conjunction',
			specialSyntax: null
		}),
		etenim: new Word({
			...
			notes: _('<p>' + 'Identical to but stronger than <b class="Latin">enim</b> in usage, and <i>not</i> postpositive.' + '<p>'),
			type: 'conjunction',
			specialSyntax: null
		}),
		nam: new Word({
			statement: 'nam',
			definition: '(conj.) for',
			notes: _('<p>' + '<b class="Latin">Nam</b> is used to join two sentences or clauses when the second sentence or clause <u>explains</u> or <u>confirms</u> a preceding one.' + '<br><u>Ex.</u> <b class="Latin">Re_gi_na ad oppidum ambulat. <u>Nam</u> do_na di_s dare optat.</b> - (explanation) <i>The queen is walking to the town. <u>For</u> she desires to give gifts to the gods.</i>' + '<p>'),
			type: 'conjunction',
			specialSyntax: null
		}),
		namque: new Word({
			...
			notes: _('<p>' + 'Identical to but stronger than <b class="Latin">nam</b> in usage.' + '<p>'),
			type: 'conjunction',
			specialSyntax: null
		}),
		neque: new Word({
		...
		ubi: new Word({
			...
			notes: '<p>May be used as a subordinating conjunction (when) that introduces a temporal clause, or as an interrogative adverb (when, where) that introduces a question.' + '<br><u>Ex.</u> <b class="Latin">Ubi ad oppidum venit, labo_ra_re no_n optat.</b> - <i>When she comes to the town, she does not desire to work.</i>' + '<br><u>Ex.</u> <b class="Latin">Ubi veniet? Ubi est? Ubi est Ro_ma?</b> - <i>When will she come? Where is she? Where is Rome?</i>' + '</p>',
			type: 'conjunction',
			specialSyntax: null
		}),
		ut: new Word({
			...
			notes: '<p>Often used with the adverb <b class="Latin">si_c</b> to make comparisons. The subordinate clause introduced by <b class="Latin">ut</b> provides a <i>standard of comparison</i> for the main clause that includes <b class="Latin">si_c</b>.' + '<br><u>Ex.</u> <b class="Latin">Ut agricola agro_s, si_c poe_ta verba co_gitat.</b> - <i> As a farmer ponders the fields, so a poet ponders words.</i>' + '</p>',
			type: 'conjunction',
			specialSyntax: null
		}),
		...
		autem: new Word({
			...
			notes: '<p>Joins two sentences or clauses.' + '<br><u>Ex:</u> <b class="Latin">Nihil scri_bo_. Multa autem lego_.</b> - <i>I write nothing. However, I read many things.</i>' + '<br><u>Ex:</u> <b class="Latin">Anto_nius bene di_cit. Bene autem scri_bit.</b> - <i>Antony speaks well. Moreover, he writes well.</i>' + '</p>',
			type: 'conjunction',
			specialSyntax: null
		}),
		...
		aut: new Word({
			statement: 'aut',
			definition: '(conj.) or',
			notes: '<p><b class="Latin">aut</b> is a coordinating conjunction that connects only parallel or grammatically balanced words, phrases, or clauses. It joins a previous word, phrase, or clause with another equivalent one that is antithetical to it. It is used to indicate mutually exclusive propositions.' + '<br><u>Ex:</u> <b class="Latin">Incola est fe_mina aut vir.</b> - <i>The inhabitant is a woman or a man.</i>' + '</p>',
			type: 'conjunction',
			specialSyntax: null
		}),
		verum: new Word({
	...
	adverbs: {
		...
		mox: new Word({
			...
			notes: '<p>' + '<br><u>Ex.</u> <b class="Latin">Poe_ta in viam ambulat. <u>Mox</u> re_gi_nam vide_bit.</b> - <i>The poet is walking into the street. <u>Soon</u> he will see the queen.</i>' + '<br><u>Ex.</u> <b class="Latin">Poe_ta i_ram viro_rum co_gita_bit, <u>mox</u> deo_rum.</b> - <i>The poet will ponder the anger of men, <u>then</u> of the gods.</i>' + '</p>',
			type: 'conjunction',
			specialSyntax: null
		}),
		nunc: new Word({
		...
		sic: new Word({
			...
			notes: '<p>Indicates that the action of the verb it modifies is being done in a manner that has just been indicated in a preceding clause or sentence, or is about to be indicated in a following clause or sentence.' + '<br><u>Ex.</u> <b class="Latin">Si_c pugna_bant.</b> - <i>They were fighting in such a way (as I have just described).</i> or <i>They were fighting in such a way (as I shall now describe).</i>' + '<br>Often used with the subordinating conjunction <b class="Latin">ut</b> to make comparisons. The subordinate clause introduced by <b class="Latin">ut</b> provides a <i>standard of comparison</i> for the main clause that includes <b class="Latin">si_c</b>.' + '<br><u>Ex.</u> <b class="Latin">Ut agricola agro_s, si_c poe_ta verba co_gitat.</b> - <i> As a farmer ponders the fields, so a poet ponders words.</i>' + '</p>',
			type: 'adverb',
			specialSyntax: null
		}),
		tamen: new Word({
			...
			notes: '<p>Regularly ocurs in a main clause following a concessive clause. May also occur without an expressed concession in the preceding clause or sentence to indicate that the statement that includes it is true in spite of what has just been said.' + '<br><u>Ex.</u> <b class="Latin">Quamquam bonam fa_mam opta_s, tamen cum incoli_s mali_s no_n pugna_s.</b> - <i>Although you desire a good reputation, nevertheless you are not fighting against the bad inhabitants.</i>' + '<br><u>Ex.</u> <b class="Latin">Dominus no_n est in agri_s. Servus tamen cum di_ligentia_ labo_rat.</b> - <i>The master is not in the fields. Neverthess, the slave is working diligently.</i>' + '</p>',
			type: 'adverb',
			specialSyntax: null
		}),
		ubi: new Word({
		...
		etiam: new Word({
			...
			notes: '<p>Derived from combination of adverbs <b class="Latin">et</b> and <b class="Latin">iam</b>. Adds a fact or thought to one already mentioned (also). That idea or thought is usually understood to be more important (even). When the additional thought is related to time, <b class="Latin">etiam</b> often means "still." It is most often placed immediately before the word indicating the fact or thought being added.' + '<br><u>Ex:</u> <b class="Latin">Disce_dam. No_n etiam time_bo_.</b> - <i>I shall depart. I shall not also fear.</i>' + '<br><u>Ex:</u> <b class="Latin">Etiam puero_s ex pro_vincia_ age_s?</b> - <i>Will you drive even the boys out of the province?</i>' + '<br><u>Ex:</u> <b class="Latin">Quoniam supera_visti_, viro_s interficere etiam opta_s?</b> - <i>Because you have conquered, do you still desire to kill the men?</i>' + '</p>',
			type: 'adverb',
			specialSyntax: null
		}),
		ita: new Word({
			...
			notes: '<p>May refer to what precedes or follows. Like <b class="Latin">si_c</b>, it may be used in comparisons to correlate with <b class="Latin">ut</b>.' + '<br><u>Ex:</u> <b class="Latin">No_n ita amo_ ut homine_s.</b> - <i>I do not love so as humans (do).</i>' + '<br>In answers, it is used for strong affirmation or negation.' + '<br><u>Ex:</u> <b class="Latin">Ita est.</b> - <i>It is so.</i>' + '<br><u>Ex:</u> <b class="Latin">No_n est ita.</b> - <i>It is not so.</i>' + '<br>In questions, it often adds a mocking or surprised tone and expects the answer "yes."' + '<br><u>Ex:</u> <b class="Latin">Itane est?</b> - <i>Is it so?</i>' + '</p>',
			type: 'adverb',
			specialSyntax: null
		}),
		ne: new Word({
		...
		vero: new Word({
			...
			notes: '<p>An irregular adverb derived from the adjective <b class="Latin">ve_rus, -a, -um</b>. Although it may mean "truly", it is more often used in answers to express agreement (certainly, indeed) <i>or</i> with mild adversative force to join two sentences (but [in truth]) and add an additional corroborating thought. In this second usage, it is always postpositive.' + '<br><u>Ex:</u> <b class="Latin">"Fuisti_ne in oppido_?" "Ve_ro_."</b> - <i>"Were you in the town?" "Indeed (I was)."</i>' + '<br><u>Ex:</u> <b class="Latin">Bonus poe_ta erat Catullus, magnus ve_ro_ Vergilius.</b> - <i>Catullus was a good poet, but (in truth) Vergil (was a) great (one).</i>' + '</p>',
			type: 'adverb',
			specialSyntax: null
		}),
	...
	pronouns: {
		...
		ego: new Word({
			...
			notes: '<p>' + 'Nominative case forms of personal pronouns are most often used for added emphasis only.' + '<br>Genitive forms of the first and second person personal pronouns may <i>only</i> be used for the <i>Objective</i> and <i>Partitive</i> Genitive. (To indicate possession, the corresponding possessive adjective is used.) When the genitive plural ends in <span class="Latin">-um</span>, it is Partitive, and in <span class="Latin">-i_</span>, Objective.' + '<br>When a first or second person personal pronoun functions as an Ablative of Accompaniment, <span class="Latin">cum</span> is attached directly to the end, e.g. <span class="Latin">' + _('me_cum') + '</span> - <i>with me</i>, <span class="Latin">' + _('no_bi_scum') + '</span> - <i>with us</i>.' + '</p>',
		...
		tu: new Word({
			...
			notes: '<p>' + 'Nominative case forms of personal pronouns are most often used for added emphasis only.' + '<br>Genitive forms of the first and second person personal pronouns may <i>only</i> be used for the <i>Objective</i> and <i>Partitive</i> Genitive. (To indicate possession, the corresponding possessive adjective is used.) When the genitive plural ends in <span class="Latin">-um</span>, it is Partitive, and in <span class="Latin">-i_</span>, Objective.' + '<br>When a first or second person personal pronoun functions as an Ablative of Accompaniment, <span class="Latin">cum</span> is attached directly to the end, e.g. <span class="Latin">' + _('te_cum') + '</span> - <i>with you</i>, <span class="Latin">' + _('vo_bi_scum') + '</span> - <i>with you (pl.)</i>.' + '</p>',
			type: 'pronoun personal',
			specialSyntax: null
		}),
		is: new Word({
			...
			notes: '<p>' + 'Nominative case forms of personal pronouns are most often used for added emphasis only.' + 'The third person personal pronoun is in origin a <b>demonstrative adjective</b>, and it retains this use, e.g. <span class="">eum virum</span> - this (or that) man (d.o.), <span class="Latin">' + _('ea peri_cula') + '</span> - these (or those) dangers.' + '<br> It has no corresponding possessive adjective, and its genitive singular and plural forms may be used as Genitives of Possession.' + '</p>',
			type: 'pronoun personal',
			specialSyntax: null
		}),
		ea: new Word({
		...
		mei_: new Word({
			...
			notes: '<p>' + 'A reflexive pronoun <i>bends back</i> - <span class="Latin">' + _('reflecto_') + '</span> (<i>bend back</i>) - or <i>refers to</i> the subject of the clause or sentence in which it appears, e.g. <i>I saw myself in the mirror</i>, <i>The women spoke among themselves</i>.' + '<br>There are no nominative forms of the reflexive pronouns because reflexive pronouns <i>refer to but never are</i> the subjects of the clauses or sentences in which they appear.' + '<br>The genitive forms of reflexive pronouns, like those of personal pronouns, can be used as <i>Partitive</i> or <i>Objective Genitives</i> only. For possession, the corresponding reflexive-possessive adjective is used.' + '<br>When a reflexive pronoun functions as an Ablative of Accompaniment, <span class="Latin">cum</span> is attached directly to the end, e.g. <span class="Latin">' + _('me_cum') + '</span> - <i>with myself</i>, <span class="Latin">' + _('no_bi_scum') + '</span> - <i>with ourselves</i>.' + '</p>',
		...
		tui_: new Word({
			...
			notes: '<p>' + 'A reflexive pronoun <i>bends back</i> - <span class="Latin">' + _('reflecto_') + '</span> (<i>bend back</i>) - or <i>refers to</i> the subject of the clause or sentence in which it appears, e.g. <i>I saw myself in the mirror</i>, <i>The women spoke among themselves</i>.' + '<br>There are no nominative forms of the reflexive pronouns because reflexive pronouns <i>refer to but never are</i> the subjects of the clauses or sentences in which they appear.' + '<br>The genitive forms of reflexive pronouns, like those of personal pronouns, can be used as <i>Partitive</i> or <i>Objective Genitives</i> only. For possession, the corresponding reflexive-possessive adjective is used.' + '<br>When a reflexive pronoun functions as an Ablative of Accompaniment, <span class="Latin">cum</span> is attached directly to the end, e.g. <span class="Latin">' + _('te_cum') + '</span> - <i>with yourself</i>, <span class="Latin">' + _('vo_bi_scum') + '</span> - <i>with yourselves</i>.' + '</p>',
			type: 'pronoun reflexive',
			specialSyntax: null
		}),
		sui_: new Word({
			...
			notes: '<p>' + 'A reflexive pronoun <i>bends back</i> - <span class="Latin">' + _('reflecto_') + '</span> (<i>bend back</i>) - or <i>refers to</i> the subject of the clause or sentence in which it appears, e.g. <i>I saw myself in the mirror</i>, <i>The women spoke among themselves</i>.' + '<br>There are no nominative forms of the reflexive pronouns because reflexive pronouns <i>refer to but never are</i> the subjects of the clauses or sentences in which they appear.' + '<br>The genitive forms of reflexive pronouns, like those of personal pronouns, can be used as <i>Partitive</i> or <i>Objective Genitives</i> only. For possession, the corresponding reflexive-possessive adjective is used.' + '<br>When a reflexive pronoun functions as an Ablative of Accompaniment, <span class="Latin">cum</span> is attached directly to the end, e.g. <span class="Latin">' + _('se_cum') + '</span> - <i>with himself, with herself, with itself; with themselves</i>.' + '<br>The alternate accusative and ablative forms <span class="Latin">' + _('se_') + '</span> and <span class="Latin">' + _('se_se_') + '</span> are interchangeable, although originally <span class="Latin">' + _('se_se_') + '</span> may have conveyed greater emphasis.' + '</p>',
			type: 'pronoun reflexive',
			specialSyntax: null
		}),
	...
	other: {
		...
		'-ne': new Word({
			...
			notes: '<p>' + 'Its usage in questions is <i>optional</i>, and it has no English translation.' + '</p>',
			type: 'other',
			specialSyntax: null
		}),
	...
	syntax: {
		...
		'Nominative, Subject': new Word({
			...
			notes: '<p>' + 'A nominative used to identify the Subject (that which is spoken about) of a verb.' + '<br>Ex. <i><u>John</u> is a waiter.</i>' + '</p>', // *
			type: 'syntax',
			specialSyntax: ''
		}),
		'Predicate Nominative': new Word({
			...
			notes: '<p>' + 'A nominative used to express an element that is <i>equivalent to</i> to the subject and is joined to it by a <i>linking</i> or <i>copulative</i> verb.' + '<br>Ex. <i>John is a <u>waiter</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Genitive of Possession': new Word({
			...
			notes: '<p>' + 'A genitive used to express a person or thing who <i>owns</i> or <i>possesses</i> another noun.' + '<br>Ex. <i>The book <u>of the girl</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Dative of Reference': new Word({
			...
			notes: '<p>' + 'A dative used to xpress a person or thing <i>with reference to whom</i> the action of the verb occurs.' + '<br>Ex. <i><u>To the sailor</u>, the danger of the sea is real</i>.' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Dative of Indirect Object': new Word({
			...
			notes: '<p>' + 'A dative used to expresses the person or thing <i>indirectly</i> interested in the action of the verb. Most often occurs with verbs of <i>giving</i>, <i>showing</i>, or <i>telling</i>.' + '<br>Ex. <i>The girl gives a toy <u>to the cat</u>.</i>' + '<br>Ex. <i>The girl gives <u>the cat</u> a toy.</i></i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Accusative, Direct Object': new Word({
			...
			notes: '<p>' + 'An accusative used to express the person or thing <i>receiving the action of the verb</i>.' + '<br>Ex. <i>The poet writes <u>poems</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Ablative of Accompaniment': new Word({
			...
			notes: '<p>' + 'An ablative used to express the person (occasionally the thing) that <i>accompanies</i> another noun in the sentence. <br><i>Always</i> uses the preposition <b class="Latin">cum</b>.' + '<br>Ex. <i>The woman came to the party <u>with a poet</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Ablative of Means': new Word({
			...
			notes: '<p>' + 'An ablative used to express the <i>thing by means of which</i> an action is performed. <br><i>Never</i> uses a preposition.' + '<br>Ex. <i>The farmer is fighting <u>with a sword</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		...
		'Complementary Infinitive': new Word({
			...
			notes: '<p>' + 'An infinitive used to <i>complete</i> the meaning of another verb.' + '<br>Ex. <b class="Latin">' + _('I_nsulam vide_re possum.') + '</b> - <i>I am able <u>to see</u> the island.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Object Infinitive': new Word({
			...
			notes: '<p>' + 'An infinitive used as the <i>direct object</i> of another verb.' + '<br>Ex. <b class="Latin">' + _('Agricola labo_ra_re optat.') + '</b> - <i>The farmer desires <u>to work</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Dative of the Possessor': new Word({
			...
			notes: '<p>' + 'A dative used to indicate the person who possesses something.' + '<br>Ex. <b class="Latin">' + _('Domino_ est liber.') + '</b> - <i> <u>To the master</u> there is a book. (The master has a book.)</i>' + '<br>In a sentence containing a Dative of the Possessor, the noun <i>possessed</i> appears in the nominative case as the subject of a form of the verb <b class="Latin">sum</b>. In the above example, the book <i>is</i> to the master. The Dative of the Possessor is <i>always</i> a person.' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		...
		'Substantive': new Word({
			...
			notes: '<p>' + 'An adjective used as a noun - the translation must indicate gender and number.' + '<br>Ex. <b class="Latin">Multa videt.</b> - <i>He sees <u>many things</u>.</i>' + '<br>Ex. <b class="Latin">Laetus bonam amat.</b> - <i><u>The happy man</u> loves <u>the good woman</u>.</i>' + '<br>The substantive use of the masculine plural <i>may</i> refer to groups of mixed gender.' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Predicate Adjective': new Word({
			...
			notes: '<p>' + 'An adjective that appears with a copulative verb. Agrees with the noun it modifies in gender, number, and case.' + '<br>Ex. <b class="Latin">' + _('Cla_rus est poe_ta') + '.</b> - <i>The poet is <u>famous</u>.</i>' + '<br>Ex. <b class="Latin">' + _('Puero_s iube_bo_ esse bono_s') + '.</b> - <i>I shall order the boys to be <u>good</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Ablative of Personal Agent': new Word({
			...
			notes: '<p>' + 'An ablative used to express the person or agent by whom an action is performed. It occurs with verbs in the passive voice and <u>requires</u> the preposition <b class="Latin">' + _('a_ / ab') + '</b>.' + '<br>Ex. <b class="Latin">' + _('Fi_lius <u>a_ re_gi_na_</u> voca_ba_tur.<u></u>') + '</b> - <i>The son was being summoned <u>by the queen</u></i>.' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Ablative of Manner': new Word({
			...
			notes: '<p>' + 'An ablative used to express the way or manner in which an action is performed. It requires <b class="Latin">cum</b> when <i>not</i> modified by an adjective. It does not require <b class="Latin">cum</b> when it <i>is</i> modified by an adjective.' + '<br>Ex. <b class="Latin">' + _('<u>Cum di_ligentia_</u> labo_rat.') + '</b> - <i>She works <u>with diligence</u>. (She works <u>diligently</u>.)</i>' + '<br>Ex. <b class="Latin">' + _('<u>Magna_ (cum)</u> di_ligentia_ labo_rat.') + '</b> - <i>She works <u>with great diligence</u>.</i>' + '<br>Note that when cum appears with an ablative of manner that is modified by an adjective, it is usually placed between the adjective and the ablative, as it is the least important element of the phrase (preposition), and greater balance of the important elements (noun and adjective) is achieved. - <i>This is according to Keller and Russell.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Subject Infinitive': new Word({
			...
			notes: '<p>' + 'An infinitive (neuter singular verbal noun) used as the <i>subject</i> of another verb.' + '<br>Ex. <b class="Latin">Bonum est ' + _('<u>labo_ra_re</u>') + '</b> - <i><u>To work</u> is good. (It is good to work.) (Working is good.)</i>.' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Appositive': new Word({
			...
			notes: '<p>' + 'A noun that defines or limits another noun next to which it is placed. It always agrees with the noun it defines in case.' + '<br>Ex. ' + _('<b class="Latin">Hora_tius, poe_ta <u>magnus</u>, multo_s libro_s habet.</b>') + ' - <i>Horace, the great <u>poet</u>, has many books.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		...
		'Partitive Genitive': new Word({
			...
			notes: '<p>' + 'A genitive that represents the <i>whole</i> out of which another noun is a <i>part</i>.' + '<br>Ex. <b class="Latin">Multi_ ' + '<u>agrico_la_rum</u>' + ' no_n labo_ra_bant.</b> - <i>Many <u>of the farmers</u> were not working.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Subjective Genitive': new Word({
			...
			notes: '<p>' + 'A genitive that expresses the person or thing <i>performing</i> the verbal action implied in another noun.' + '<br>Ex. <b class="Latin">Magnum erat odium <u>Sullae</u> in Ro_ma_no_s.</b> - <i>Great was the hatred <u>of Sulla</u> against the Romans.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Objective Genitive': new Word({
			...
			notes: '<p>' + 'A genitive that expresses the person or thing <i>receiving</i> the verbal action implied in another noun. May be translated with English "for".' + '<br>Ex. <b class="Latin">Re_gi_na odium <u>populi_</u> habet.</b> - <i>The queen has hatred <u>of (for) the people</u>.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
		'Ablative of Respect': new Word({
			...
			notes: '<p>' + 'An ablative that limits or specifies the meaning of an adjective or verb. No preposition is used.' + '<br>Ex. <b class="Latin">Magnus <u>co_nsilio_</u> erat poe_ta.</b> - <i>The poet was great <u>in (respect to)</u> judgement.</i>' + '</p>',
			type: 'syntax',
			specialSyntax: ''
		}),
...
var decks = {
	chapterOne: {
		title: 'LTRL Ch 1',
		deck: [V.nouns.agricola, V.nouns.anima, V.nouns.dea, V.nouns.fama, V.nouns.femina, V.nouns.filia, V.nouns.insula, V.nouns.Italia, V.nouns.nauta, V.nouns.patria, V.nouns.pecunia, V.nouns.poeta, V.nouns.puella, V.nouns.regina, V.nouns.via, V.nouns.ager, V.nouns.deus, V.nouns.dominus, V.nouns.filius, V.nouns.gladius, V.nouns.liber, V.nouns.puer, V.nouns.servus, V.nouns.vir, V.nouns.aurum, V.nouns.bellum, V.nouns.consilium, V.nouns.donum, V.nouns.factum, V.nouns.ferrum, V.nouns.oppidum, V.nouns.periculum, V.nouns.verbum, V.prepositions.ab, V.prepositions.ad, V.prepositions.cum, V.prepositions.de, V.prepositions.ex, V.conjunctions.et, V.adverbs.et, V.other['et...et...'], V.prepositions.in, V.interjections.o, V.conjunctions['-que']]
	},
	chapterTwo: {
		title: 'LTRL Ch 2',
		deck: [V.nouns.cura, V.nouns.ira, V.nouns.poena, V.nouns.sapientia, V.nouns.vita, V.nouns.animus, V.nouns.arma, V.nouns.studium, V.nouns.velum, V.verbs.ambulo, V.verbs.amo, V.verbs.cogito, V.verbs.do, V.idioms['poenas dare'], V.idioms['vela dare'], V.verbs.dono, V.verbs.erro, V.verbs.laboro, V.verbs.monstro, V.verbs.opto, V.verbs.voco, V.verbs.debeo, V.verbs.habeo, V.verbs.iubeo, V.verbs.moveo, V.verbs.respondeo, V.verbs.timeo, V.verbs.video, V.verbs.sum, V.verbs.possum, V.adverbs.cur, V.conjunctions.enim, V.conjunctions.etenim, V.conjunctions.nam, V.conjunctions.namque, V.other['-ne'], V.adverbs.neque, V.other['nec...nec...'], V.adverbs.non, V.conjunctions.sed]
	},
	chapterThree: {
		title: 'LTRL Ch 3',
		deck: [V.nouns.diligentia, V.nouns.incola, V.nouns.mora, V.nouns.provincia, V.nouns.terra, V.nouns.amicus, V.nouns.forum, V.nouns.imperium, V.nouns.inimicus, V.nouns.odium, V.nouns.populus, V.nouns.Romani, V.nouns.nihil, V.verbs.laudo, V.verbs.pugno, V.verbs.supero, V.verbs.teneo, V.verbs.video, V.verbs.eo, V.adjectives.amicus, V.adjectives.inimicus, V.adjectives.bonus, V.adjectives.laetus, V.adjectives.liber, V.adjectives.magnus, V.adjectives.malus, V.adjectives.miser, V.adjectives.multus, V.adjectives.parvus, V.adjectives.pulcher, V.adjectives.Romanus, V.prepositions.ab, V.conjunctions.atque, V.adverbs.mox, V.adverbs.nunc, V.prepositions.pro, V.prepositions.propter, V.adverbs.semper, V.prepositions.sine, V.adverbs.autem, V.adjectives.humanus, V.verbs.ignosco, V.adverbs.etiam, V.adverbs.saepe, V.prepositions.sub, V.nouns.palliolum, V.adjectives.sordidus, V.adjectives.mutuus, V.nouns.acervus, V.verbs.apto, V.verbs.conicio, V.verbs.recipero, V.nouns.sarcina]
	},
	chapterFour: {
		title: 'LTRL Ch 4',
		deck: [V.nouns.causa, V.nouns.gloria, V.nouns.invidia, V.nouns.sententia, V.nouns.altum, V.nouns.auxilium, V.nouns.auxilia, V.nouns.caelum, V.nouns.socius, V.verbs.ago, V.idioms['causam agere'], V.verbs.cano, V.verbs.capio, V.idioms['consilium capere'], V.verbs.dico, V.verbs.duco, V.verbs.facio, V.verbs.gero, V.idioms['bellum gerere'], V.verbs.mitto, V.verbs.pono, V.verbs.rego, V.verbs.scribo, V.verbs.audio, V.verbs.sentio, V.verbs.venio, V.pronouns.ego, V.pronouns.tu, V.pronouns.is, V.pronouns.ea, V.pronouns.id, V.adjectives.meus, V.adjectives.noster, V.adjectives.tuus, V.adjectives.vester, V.adjectives.altus, V.adjectives.clarus, V.adjectives.cupidus, V.adjectives.decem, V.adjectives.socius, V.adjectives.validus, V.adverbs.equidem, V.adverbs.quidem, V.other['ne...quidem'], V.prepositions.per]
	},
	chapterFive: {
		title: 'LTRL Ch 5',
		deck: [V.nouns.amicitia, V.nouns.inimicitia, V.nouns.fatum, V.nouns.proelium, V.verbs.accipio, V.verbs.cedo, V.verbs.accedo, V.verbs.discedo, V.verbs.interficio, V.verbs.perficio, V.verbs.abeo, V.verbs.fero, V.verbs.memini, V.verbs.odi, V.verbs.redeo, V.pronouns.mei_, V.pronouns.tui_, V.pronouns.sui_, V.adjectives.mea, V.adjectives.tua, V.adjectives.nostra, V.adjectives.vestra, V.adjectives.suus, V.adjectives.ipse, V.adjectives.durus, V.adjectives.pius, V.adjectives.impius, V.adverbs.bene, V.adverbs.male, V.adverbs.multum, V.adverbs.sic, V.adverbs.tamen, V.conjunctions.etsi, V.conjunctions.nisi, V.conjunctions.postquam, V.conjunctions.quamquam, V.conjunctions.quoniam, V.conjunctions.si, V.conjunctions.ubi, V.conjunctions.ut]
	},
	chapterSix: {
		title: 'LTRL Ch 6',
		deck: [V.nouns.Athenae, V.nouns.natura, V.nouns.Roma, V.nouns.dictum, V.nouns.domus, V.nouns.amor, V.nouns.animal, V.nouns.carmen, V.nouns.Carthago, V.nouns.civis, V.nouns.corpus, V.nouns.frater, V.nouns.homo, V.nouns.hostis, V.nouns.ius, V.nouns.mare, V.nouns.mater, V.nouns.mens, V.nouns.miles, V.nouns.moenia, V.nouns.pater, V.nouns.rex, V.nouns.rus, V.nouns.servitus, V.nouns.soror, V.nouns.timor, V.nouns.urbs, V.nouns.vis, V.verbs.libero, V.verbs.careo, V.verbs.lego, V.verbs.intellego, V.verbs.vivo, V.adjectives.antiquus, V.adjectives.novus, V.adjectives.pauci, V.conjunctions.autem, V.prepositions.inter, V.prepositions.sub, V.adverbs.umquam, V.adverbs.numquam, V.idioms['patres conscripti'], V.adverbs.iure]
	},
	chapterSeven: {
		title: 'LTRL Ch 7',
		deck: [V.nouns.ara, V.nouns.copia, V.nouns.fortuna, V.nouns.insidiae, V.nouns.umbra, V.nouns.ingenium, V.nouns.templum, V.nouns.ars, V.nouns.civitas, V.nouns.mors, V.nouns.pars, V.nouns.virtus, V.nouns.vox, V.verbs.maneo, V.verbs.terreo, V.verbs.cupio, V.verbs.fugio, V.verbs.peto, V.verbs.trado, V.verbs.vinco, V.verbs.aufero, V.verbs.differo, V.adjectives.acerbus, V.adjectives.carus, V.adjectives.certus, V.adjectives.incertus, V.adjectives.falsus, V.adjectives.verus, V.adverbs.ante, V.adverbs.etiam, V.adverbs.ita, V.adverbs.ne, V.adverbs.post, V.adverbs.solum, V.adverbs.vero, V.conjunctions.aut, V.conjunctions.verum, V.other.utinam, V.other['aut...aut...'], V.other['non solum...sed']]
	},
	chapterEight: {
		title: 'LTRL Ch 8',
		deck: [V.interjections.salve, V.interjections.vale, V.interjections.ecce, V.interjections.hercule, V.interjections.mehercule, V.interjections.heu, V.nouns.salus, V.idioms['salutem dicere'], V.verbs.valeo, V.nouns.fuga, V.nouns.annus, V.nouns.locus, V.nouns.consul, V.nouns.nox, V.nouns.tempus, V.nouns.consulatus, V.nouns.domus4, V.nouns.exercitus, V.nouns.manus, V.nouns.motus, V.nouns.senatus, V.nouns.acies, V.nouns.dies, V.nouns.fides, V.nouns.res, V.idioms['res gestae'], V.idioms['res novae'], V.idioms['res publica'], V.nouns.species, V.adjectives.publicus, V.adjectives.acer, V.adjectives.facilis, V.adjectives.difficilis, V.adjectives.felix, V.adjectives.infelix, V.adjectives.fortis, V.adjectives.ingens, V.adjectives.omnis, V.adjectives.hic, V.adjectives.iste, V.adjectives.ille, V.verbs.conor, V.verbs.fateor, V.verbs.sequor, V.verbs.morior, V.verbs.experior, V.verbs.audeo, V.verbs.relinquo, V.adverbs.quoque, V.adverbs.saepe]
	},
	chapterNine: {
		title: 'LTRL Ch 9',
		deck: [V.nouns.exsilium, V.nouns.modus, V.idioms['quo modo'], V.nouns.oculus, V.nouns.lex, V.idioms['legem ferre'], V.nouns.libertas, V.nouns.pax, V.nouns.metus, V.nouns.spes, V.pronouns.qui, V.adjectives.qui, V.pronouns.quis, V.verbs.hortor, V.verbs.impero, V.verbs.moneo, V.verbs.pareo, V.verbs.placeo, V.verbs.patior, V.verbs.pello, V.verbs.quaero, V.adjectives.caecus, V.adjectives.gravis, V.adjectives.levis, V.adjectives.alius, V.adjectives.alter, V.adjectives.idem, V.adjectives.neuter, V.adjectives.nullus, V.adjectives.solus, V.adjectives.totus, V.adjectives.ullus, V.adjectives.unus, V.adjectives.uter, V.adverbs.iam, V.adverbs.tandem, V.adverbs['quam ob rem'], V.adverbs.quare, V.prepositions.ob, V.conjunctions.ne, V.conjunctions.ut]
	},
	chapterTen: {
		title: 'LTRL Ch 10',
		deck: [V.nouns.legatus, V.nouns.natus, V.nouns.dux, V.nouns.finis, V.nouns.genus, V.nouns.labor, V.nouns.mos, V.nouns.nemo, V.nouns.opus, V.idioms['opus est'], V.nouns.oratio, V.idioms['orationem habere'], V.nouns.orator, V.nouns.pectus, V.nouns.casus, V.pronouns.quidam, V.adjectives.quidam, V.verbs.oppugno, V.verbs.servo, V.verbs.sto, V.verbs.deleo, V.verbs.cado, V.verbs.nascor, V.verbs.nosco, V.verbs.cognosco, V.verbs.proficiscor, V.verbs.utor, V.verbs.perfero, V.verbs.refero, V.adjectives.aequus, V.adjectives.iniquus, V.adjectives.honestus, V.adjectives.medius, V.adverbs.magnopere, V.adverbs.quo, V.adverbs.ubi, V.adverbs.unde, V.adverbs.contra, V.adverbs.satis, V.prepositions.apud, V.conjunctions.quin]
	},
	chapterEleven: {
		title: 'LTRL Ch 11',
		deck: [V.nouns.audacia, V.nouns.campus, V.nouns.castra, V.nouns.murus, V.nouns.paulum, V.nouns.signum, V.nouns.telum, V.nouns.ignis, V.nouns.imperator, V.nouns.legio, V.nouns.lux, V.nouns.maiores, V.nouns.sensus, V.idioms['prima luce'], V.idioms['castra ponere'], V.idioms['castra movere'], V.verbs.arbitror, V.verbs.puto, V.verbs.soleo, V.verbs.credo, V.verbs.iacio, V.verbs.eicio, V.verbs.loquor, V.verbs.invenio, V.verbs.scio, V.verbs.nescio, V.verbs.pereo, V.adjectives.longus, V.adjectives.summus, V.adjectives.brevis, V.adjectives.sapiens, V.adjectives.similis, V.adjectives.dissimilis, V.adverbs.diu, V.adverbs.longe, V.adverbs.parum, V.adverbs.primum, V.idioms['quam primum'], V.adverbs.quam, V.conjunctions.igitur]
	},
	LLChaptersOneToTen: {
		title: 'LL Ch 1-10',
		deck: []
	...
	nouns: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.nouns) ret.push(V.nouns[i]);
			return ret;
		})()
	},
	verbs: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.verbs) ret.push(V.verbs[i]);
			return ret;
		})()
	},
	pronouns: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.pronouns) ret.push(V.pronouns[i]);
			return ret;
		})()
	},
	adjectives: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.adjectives) ret.push(V.adjectives[i]);
			return ret;
		})()
	},
	conjunctions: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.conjunctions) ret.push(V.conjunctions[i]);
			return ret;
		})()
	},
	prepositions: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.prepositions) ret.push(V.prepositions[i]);
			return ret;
		})()
	},
	other: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.other) ret.push(V.other[i]);
			return ret;
		})()
	},
	syntax: {
		...
		deck: (() => {
			var ret = [];
			for (var i in V.syntax) ret.push(V.syntax[i]);
			return ret;
		})()
	},
	names: {
		title: 'Names',
		deck: [V.nouns.Iuppiter, V.nouns.Iuno, V.nouns.Neptunus, V.nouns.Dis, V.nouns.Ceres, V.nouns.Vesta, V.nouns.Venus, V.nouns.Amor, V.nouns.Cupido, V.nouns.Apollo, V.nouns.Diana, V.nouns.Minerva, V.nouns.Mars, V.nouns.Mercurius, V.nouns.Vulcanus, V.nouns.Bacchus, V.nouns.Liber, V.nouns.Romulus, V.nouns.Remus, V.nouns.Italia, V.nouns.Aulus, V.nouns.Appius, V.nouns.Gaius, V.nouns.Gnaeus, V.nouns.Decimus, V.nouns.Lucius, V.nouns.Marcus, V.nouns.Manius, V.nouns.Publius, V.nouns.Quintus, V.nouns.Sextus, V.nouns.Servius, V.nouns.Spurius, V.nouns.Titus, V.nouns.Tiberius, V.nouns.Graecia, V.nouns.Ilium, V.nouns.Troia, V.nouns.Iulia, V.nouns.Livia, V.nouns.Sicilia]
	},
	irregularVerbs: {
...
function MorphologyTable(word, section) {
	...
	if (word.type.slice(0, 4) === 'noun' || word.type === 'pronoun personal' || word.type === 'pronoun reflexive') {
		let declension = word.declension();

		let backgroundColor = '#c0cfe4';

		table += `<tr><td style="background-color: ${backgroundColor};" colspan="1"></td>`;
		for (let n = 0; n < NUMBERS.length; n++) table += `<th style="background-color: ${backgroundColor};">${NUMBERS[n]}</th>`;
		table += '</tr>';
		...
		for (var c = 0; c < CASES.length; c++) {
			...
			for (let n = 0; n < NUMBERS.length; n++) {
				...
				if (ss) table += `<td style="text-align: center; color: red; background-color: white;">` + ss + '</td>';else table += '<td style="text-align: center; background-color: white;">' + declension[CASES[c]][NUMBERS[n]] + '</td>';
			}
			table += '</tr>';
		}
	}
	...
	// Adjectives
	if (word.type.slice(0, 9) === 'adjective' || word.type === 'pronoun relative' || word.type === 'pronoun interrogative' || word.type === 'pronoun indefinite') {
		...
		for (let n = 0; n < NUMBERS.length; n++) table += `<th style="background-color: ${backgroundColor};" colspan="3">${NUMBERS[n]}</th>`;
		table += '</tr>';

		table += '<tr>';
		for (let n = 0; n < NUMBERS.length; n++) for (let g = 0; g < GENDERS.length; g++) table += `<th style="background-color: ${backgroundColor};">${GENDERS[g]}</th>`;
		table += '</tr>';
			...
			for (let n = 0; n < NUMBERS.length; n++) {
				for (let g = 0; g < GENDERS.length; g++) {
					...
					let props = [CASES[c], NUMBERS[n], GENDERS[g]],
					    ss = specialSyntax(word, props);
					if (ss) table += `<td style="text-align: center; color: red; background-color: white;">` + ss + '</td>';else table += '<td style="text-align: center; background-color: white;">' + declension[CASES[c]][NUMBERS[n]][GENDERS[g]] + '</td>';
				}
			}
			table += '</tr>';
		}
		if (word.type.slice(0, 9) === 'adjective' && declension.adverb && section != 'noAdverb') {
			table += `<tr><th style="background-color: ${adverbBackgroundColor};">adverb</th>` + `<td colspan="6" style="${word.specialSyntax && word.specialSyntax.adverb ? 'color: red; ' : ''}text-align: center; background-color: white;">` + declension.adverb + '</td></tr>';
		}
	}
	...
	// ( v-- under construction)
			...
			for (let m = 0; m < MOODS.length; m++) {
				...
				if (section == undefined || section == MOODS[m]) {
					...
					let backgroundColor = m == 0 ? '#c0cfe4' : m == 1 ? '#c0e4c0' : m == 2 ? '#e4d4c0' : '#e2e4c0';
					let moodTenses = m == 0 ? TENSES : m == 1 ? TENSES.filter((t, i) => i % 3 != 2) : m == 2 ? TENSES.slice(0, 1) : TENSES.slice(0, 1);

					table += '<tr>';
					table += `<th colspan="2" rowspan="2" style="background-color: ${backgroundColor};">` + MOODS[m] + '</th>';
					for (let n = 0; n < NUMBERS.length; n++) table += `<th colspan="3" style="background-color: ${backgroundColor};">` + NUMBERS[n] + '</th>';
					table += '</tr>';

					table += '<tr>';
					for (let n = 0; n < NUMBERS.length; n++) {
						if (MOODS[m] == 'imperative') table += `<th colspan="3" style="background-color: ${backgroundColor};">` + PERSONS[1] + '</th>';else for (let p = 0; p < PERSONS.length; p++) table += `<th style="background-color: ${backgroundColor};">` + PERSONS[p] + '</th>';
					}
					table += '</tr>';
							...
							for (let n = 0; n < NUMBERS.length; n++) {
								for (let p = 0; p < PERSONS.length; p++) {
									if (MOODS[m] != 'imperative' || PERSONS[p] == 'second') {
										...
										// if special syntax
										if (ss) {
											if (MOODS[m] == 'imperative' && PERSONS[p] == 'second') table += `<td colspan="3" style="text-align: center; ${word.type == 'verb Irr' ? '' : 'color: red;'} background-color: white;">`;else table += `<td style="text-align: center; ${word.type == 'verb Irr' ? '' : 'color: red;'} background-color: white;">`;
											table += ss + '</td>';
										}
										// if no special syntax
										else {
												if (MOODS[m] == 'imperative' && PERSONS[p] == 'second') table += '<td colspan="3" style="text-align: center; background-color: white;">';else table += '<td style="text-align: center; background-color: white;">';
			...
			if (section == undefined) {
				...
				for (let v = 0; v < VOICES.length; v++) table += `<th colspan="3" style="background-color: ${backgroundColor};">` + VOICES[v] + '</th>';
				table += '</tr>';
				table += '<tr>';
				for (let v = 0; v < VOICES.length; v++) for (let t = 0; t < nonFiniteTenses.length; t++) table += `<th style="background-color: ${backgroundColor};">` + nonFiniteTenses[t] + '</th>';
				table += '</tr>';
				for (let f = 0; f < nonFiniteForms.length; f++) {
					...
					for (let v = 0; v < VOICES.length; v++) {
						for (let t = 0; t < nonFiniteTenses.length; t++) {
							if (word.specialSyntax && word.specialSyntax[nonFiniteForms[f]] && word.specialSyntax[nonFiniteForms[f]][VOICES[v]] && word.specialSyntax[nonFiniteForms[f]][VOICES[v]][nonFiniteTenses[t]]) table += `<td style="text-align: center; ${word.type == 'verb Irr' ? '' : 'color: red;'} background-color: white;">` + word.specialSyntax[nonFiniteForms[f]][VOICES[v]][nonFiniteTenses[t]] + '</td>';else table += '<td style="text-align: center; background-color: white;">' + conjugation[nonFiniteForms[f]][VOICES[v]][nonFiniteTenses[t]] + '</td>';
						}
					}
					table += '</tr>';
				}
...
function Search(text) {
	...
	for (var wordType in V) {
		for (var word in V[wordType]) {
			...
			for (var i = 0; i < text.length; i++) if (V[wordType][word].statement[i] !== text[i]) matchesWord = false;
			if (matchesWord) ret.push(V[wordType][word]);
		}
	}
	return ret;
}
...
function numWords(text) {
	var count = 0;
	for (var wordType in V) for (var word in V[wordType]) count++;
	console.log(count);
}
